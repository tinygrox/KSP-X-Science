...
namespace ScienceChecklist {
	...
	public sealed class ScienceInstance {
		...
		public string Description {
			get {
				return Localizer.Format("#XScience_Situation_while", ScienceExperiment.experimentTitle, Situation.Description); // string.Format("{0} while {1}", ScienceExperiment.experimentTitle, Situation.Description);
			}
		}
